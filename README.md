# 익명 웹 페이지 만들기
멋쟁이 사자처럼 백엔드스쿨에서 개인 프로젝트로 했던 익명 웹페이지 만들기를 복습하는 프로젝트입니다.
...
![ERD](./images/ERD.png)
- board, article, comment 세개의 Entity로 기본 기능을 구현하였고, hashTag와 image 기능도 따로 entity를 만들었습니다.
